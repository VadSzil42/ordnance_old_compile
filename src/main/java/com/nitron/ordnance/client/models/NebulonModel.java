...
public class NebulonModel extends EntityModel<NebulonEntity> {
	private final ModelPart body;
	private final ModelPart mirror;
	public NebulonModel(ModelPart root) {
	...
	@Override
	public void setAngles(NebulonEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
	}
	@Override
