...
public class ConfettiParticle extends SpriteBillboardParticle {
    ...
    protected ConfettiParticle(ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ, SpriteProvider spriteProvider) {
        super(world, x, y, z);
        this.scale *= 0.1f + RANDOM.nextFloat() * 0.5f;
